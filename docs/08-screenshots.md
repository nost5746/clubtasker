...
This document lists the screenshots that were created during the development of ClubTasker.
...
This proves that the project was started with a clear folder structure.
...
This proves that the project idea was documented at the beginning.
...
This proves that Node.js, npm, and Git were installed and checked.
...
This proves that an Express backend server was created.
...
It also shows that the task `Buy drinks` was changed to `done`.

Purpose:

This proves that the frontend can send a change to the backend and update the user interface.
...
This proves that the project was versioned with Git.
...
This proves that the project was uploaded to GitHub.

---

## Summary

The screenshots document the full development process from the initial project structure to the final GitHub repository.

Together with the source code and Markdown files, they prove that the project was created step by step and that the code structure was understood.